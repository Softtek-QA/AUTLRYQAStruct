...
public class CTP00007 extends AUTSafeBaseComponent {
	...
	public void CarregarValeTroca() {
		...
		parametros = autGetDataFlow().autGetParametersFromTable(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_SAFE_MD00012_CN00007_CTP00007);
		
		CMP00084(parametros);
		
		CMP00085(parametros).autConsultaValeTrocaClientePF(parametros);
