...
public class CTP00005 extends AUTSAPBaseComponent {
	...
	public void FaturaPedidoSAP(String numPedido) {
		...
		parametros = autGetDataFlow().autGetParametersFromTable(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_SAP_MD00012_CN00002_CTP00005);
		...
		//autSetCurrentParameter(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_VA_MD00012_CN00002_CTP00006, "AUT_STATUS_ESPERADO",AUT_STATUS_ESPERADO);
		//autSetCurrentParameter(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_VA_MD00012_CN00002_CTP00006, "AUT_NUMERO_PEDIDO",AUT_NUMERO_PEDIDO);	
	}
}