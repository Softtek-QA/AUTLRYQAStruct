...
public class CTP00003 extends AUTPDVBaseComponent {
	...
	public void PagaPedidoPDV(String numPedido) {
		...
		parametros = autGetDataFlow().autGetParametersFromTable(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_PDV_MD00012_CN00009_CTP00003);
		...
		autSetCurrentParameter(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_VA_MD00012_CN00009_CTP00004, "AUT_STATUS_ESPERADO",AUT_STATUS_ESPERADO);
		autSetCurrentParameter(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_VA_MD00012_CN00009_CTP00004, "AUT_NUMERO_PEDIDO",AUT_NUMERO_PEDIDO);
	}
}