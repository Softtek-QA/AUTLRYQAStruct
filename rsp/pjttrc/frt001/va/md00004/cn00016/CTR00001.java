...
public class CTR00001 extends AUTVABaseComponent {
	 ...
	 */
	@Test
	public void ctr00016() {
		 autGetDataFlow().autInitDataFlow();
		 
			java.util.HashMap<String,Object> parameters = new java.util.HashMap<String,Object>();
			parameters = autGetDataFlow().autGetParametersFromTable(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_VA_MD00004_CN00016_CTR00001);
		    ...
		    //verificar esse objeto na tela
		    AUT_AGENT_SILK4J.<DomCheckBox>find("VA.TelaInicialLoja.PagarNaLoja").check();
			...
			autSetCurrentParameter(AUT_CURRENT_PARAMETERS_TABLE_NAME.RSP_PJTTRC_FRT001_VA_MD00004_CN00016_CTR00001, "AUT_NUMERO_PEDIDO", pedido);
