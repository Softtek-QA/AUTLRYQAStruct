...
public class CTP0001 extends AUTVABaseComponent {
	...
	public void ctp05(String numeroPedido) {
	...
	public void ctp5() {
		...
		parametros = autGetDataFlow().autGetParametersFromTable(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_VA_MD00003_CN00005_CTP00001);
		parametros.remove("AUT_NUMERO_PEDIDO");
		parametros.put("AUT_NUMERO_PEDIDO", autGetCurrentParameter(AUT_TABLE_PARAMETERS_NAMES.RSP_PJTTRC_FRT001_VA_MD00003_CN00005_CTP00001,"AUT_NUMERO_PEDIDO"));
