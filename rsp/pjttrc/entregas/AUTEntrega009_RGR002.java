...
public class AUTEntrega009_RGR002 {
	 ...
	 */
	@Test
	public void AUT_IT00000_STCFG_ID00028_FRT028_CN00000_CONFIG() {
		...
		gerTests.autInitConfigurationProjectExecution(AUTEntrega009_RGR002.class, AUT_TEST_STATUS_EXECUCAO.WAIT.toString());
	 ...
	 */
	public void AUT_IT00001_STVA_ID00028_FRT028_CN00001_MONITOR_APROVACAO_PARCIAL_LOJA0035() {
		try{
	 ...
	 */
	public void AUT_IT00002_STVA_ID00028_FRT028_CN00002_USUARIO_APROVADOR_AUMENTANDO_O_DESCONTO_APLICADO_E_APROVADO_LOJA0035() {
		try{
			gerTests.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00003_STVA_ID00028_FRT028_CN00003_USUARIO_APROVADOR_DIMINUINDO_O_DESCONTO_APLICADO_E_APROVANDO_LOJA0035() {
		try{
			gerTests.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00004_STVA_ID00028_FRT028_CN00004_USUARIO_APROVADOR_PARCIAL_AUMENTANDO_O_DESCONTO_ACIMA_DA_ALCADA_LOJA0035() {
		try{
			gerTests.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00005_STVA_ID00028_FRT028_CN00005_USUARIO_APROVADOR_ALTERANDO_O_DESCONTO_E_ABORTANDO_A_OPERACAO_LOJAS0035() {
		try{
			gerTests.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
