...
public class AUTVAWorkFlowEndToEnd_RGR0001{	
	...
	public void AUT_CFG_INIT() {
		entregas.autSetCurrentSuite(AUTVAWorkFlowEndToEnd_RGR0001.class);
		entregas.autLoaderCurrentSuite();
		entregas.autEntrega001RGR001().AUT_INIT();
		entregas.autEntrega002RGR001().AUT_INIT();
		entregas.autEntrega003RGR001().AUT_INIT();
		entregas.autEntrega004RGR001().AUT_INIT();
	}
	...
	public void AUT_IT00076_STVA_ID00003_FRT003_CN00013_RETIRADA_INTERNA_IMEDIATA_PAG_DINHEIRO_PJ_LOJA0035() {
		try {
			entregas.autEntrega001RGR001().AUT_IT00074_STVA_ID00003_FRT003_CN00013_RETIRADA_INTERNA_IMEDIATA_PAG_DINHEIRO_PJ_LOJA0035();
		}
		catch(java.lang.Exception e) {
			entregas.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.ERROR);		
		}
	...
	public void AUT_IT00094_STVA_ID00004_FRT004_CN00013_REQUISITO_CADASTRO_CLIENTE_PJ_E_CLASSIFICAR_COMO_EXCECAO(){
		try{			
			entregas.autEntrega002RGR001().AUT_IT00013_STVA_ID00004_FRT004_CN00013_REQUISITO_CADASTRO_CLIENTE_PJ_E_CLASSIFICAR_COMO_EXCECAO();
		}
		catch(java.lang.Exception e) {
			entregas.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.ERROR);
		}				
