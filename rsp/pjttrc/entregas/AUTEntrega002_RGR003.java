...
public class AUTEntrega002_RGR003 {
	 ...
	 */
	@Test
	public void AUT_IT00000_STCFG_ID00008_FRT008_CN00000_CONFIG() {
		...
		gerTests.autInitConfigurationProjectExecution(AUTEntrega002_RGR003.class, AUT_TEST_STATUS_EXECUCAO.WAIT.toString());
	
	}
	
	public void AUT_IT99999_STCFG_ID00008_FRT008_CN00000_CONFIG() {
	 ...
	 */
	@Test
	public void AUT_IT00002_STCFG_ID00008_FRT008_CN00002_VA_CADASTRO_CLIENTES() {
		try {
	 ...
	 */
	public void AUT_IT00003_STVA_ID00008_FRT008_CN00003_CADASTRO_CLIENTE_PJ_LOJA0035() {
		try{
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00004_STVA_ID00008_FRT008_CN00004_CADASTRO_CLIENTE_PF_LOJA0035() {
		try{
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00005_STVA_ID00008_FRT008_CN00005_CADASTRO_CLIENTE_ESTRANGEIRO_LOJA0035() {
		try {
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00006_STVA_ID00008_FRT008_CN00006_CADASTRO_CLIENTE_VARIOS_TELEFONES_LOJA00035() {
		try{
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00007_STVA_ID00008_FRT008_CN00007_REQUISITO_CADASTRO_CLIENTE_PF_PREVIAMENTE_CADASTRADO() {
		try{
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);			
	 ...
	 */
	public void AUT_IT00008_STVA_ID00008_FRT008_CN00008_CADASTRO_CLIENTE_PJ_PREVIAMENTE_CADASTRADO() {
		try{
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00009_STVA_ID00008_FRT008_CN00009_CADASTRO_CLIENTE_NAO_SEI_CEP() {
		try{
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00010_STVA_ID00008_FRT008_CN00010_CADASTRO_CLIENTE_PF_COM_CPF_INVALIDO() {
		try{
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00011_STVA_ID00008_FRT008_CN00011_CADASTRO_CLIENTE_PF_COM_CEP_INVALIDO() {
		try {
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00012_STVA_ID00008_FRT008_CN00012_CADASTRO_CLIENTE_PF_COM_VARIOS_ENDERECOS() {
		try {
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	...
	@Test
	public void AUT_IT00013_STVA_ID00008_FRT008_CN00013_REQUISITO_CADASTRO_CLIENTE_PJ_E_CLASSIFICAR_COMO_EXCECAO(){
		try{
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVACadastros(true).autCadastroClienteVA(hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT, hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT, AUT_VA_CADASTROS.JURIDICA, AUT_VA_TIPO_CONTATO.CELULAR, AUT_VA_TIPO_ENDERECO.COMERCIAL, AUT_VA_TIPO_RESIDENCIA.DEPOSITO_OU_GALPAO);
	 ...
	 */
	public void AUT_IT00014_STVA_ID00008_FRT008_CN00014_CADASTRO_CLIENTE_PJ_E_CLASSIFICAR_COMO_EXCECAO() {
		try {
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00015_STVA_ID00008_FRT008_CN00015_CLASSIFICAR_CLIENTE_PJ_COMO_EXCECAO() {
		try {
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 */
	public void AUT_IT00016_STVA_ID00008_FRT008_CN00016A_REALIZAR_CADASTRO_FILHO_PARA_CLIENTE_PJ_EXCECAO() {
		try {
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 *  CN00013 - Realizar um cadastro "filho" para um PJ Exceção
	 */
	public void AUT_IT00017_STVA_ID00008_FRT008_CN00016B_REALIZAR_CADASTRO_FILHO_PARA_CLIENTE_PJ_EXCECAO() {
		try {
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVACadastros().autCadastroClientePJExcecao(va.autVACadastros().AUT_NUMERO_DOC_CNPJ_OUTPUT, hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT, hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT, false);
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.PASSED);
	 ...
	 *  CN00013 - Realizar um cadastro "filho" para um PJ Exceção
	 */
	public void AUT_IT00018_STVA_ID00008_FRT008_CN00017_REALIZAR_CADASTRO_FILHO_PARA_CLIENTE_PJ_EXCECAO() {
		try {
			va.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autSetCurrentParameter(AUT_TABLE_PARAMETERS_NAMES.AUT_VA_CADASTROS, "AUT_CNPJ", va.autVACadastros().AUT_NUMERO_DOC_CNPJ_OUTPUT);
