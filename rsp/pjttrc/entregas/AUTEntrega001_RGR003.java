...
public class AUTEntrega001_RGR003{	
	//***********************************************************************************************************************	
	//***********************************************************************************************************************	
	...
	public void AUT_INIT() {
		AUT_00007_FRT007();
		AUT_AUT_IT99999_STCFG_ID00007_FRT007_CN00000();
	 ...
	 */
	@Test
	public void AUT_AUT_IT00000_STCFG_ID00007_FRT007_CN00000() {	
		...
		hmc.autHMCCadastros().autInitConfigurationProjectExecution(AUTEntrega001_RGR003.class, AUT_TEST_STATUS_EXECUCAO.WAIT.toString());
		AUT_LOJA_CADASTRO = "0035";
	}

	public void AUT_AUT_IT99999_STCFG_ID00007_FRT007_CN00000() {	
		hmc = new AUTHMCBaseServices();
		pdv = new AUTPDVBaseServices();	
		safe = new AUTSafeBaseServices();
		sap = new AUTSAPBaseServices();
	 ...
	 */
	@Test
	public void AUT_IT00001_STHMC_ID00007_FRT007_CN00001_CADASTRO_USUARIO_LOJA0035() {
		try {	
	 ...
	 */
	@Test
	public void AUT_IT00002_STCFG_ID00007_FRT007_CN00000_VA_CONFIG_CADASTRO_CLIENTES() {		
		try {						
	 ...
	 */
	@Test
	public void AUT_IT00003_STVA_ID00007_FRT007_CN00002_CADASTRO_CLIENTE_PF_LOJA0035() {		
		try {
			va.autVACadastros(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);	
	 ...
	 */
	@Test
	public void AUT_IT00004_STVA_ID00007_FRT007_CN00003_CADASTRO_CLIENTE_ESTRANGEIRO_LOJA0035() {
		va.autVACadastros(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);	
		try {
			try {
				va.autVACadastros(false).autLogoutApplication();
	 ...
	 */
	@Test
	public void AUT_IT00012_STCFG_ID00007_FRT007_CN00000_CONFIG_GERADOR_PEDIDOS_LOJA0035() {
		try {
	 ...
	 */
	public void AUT_IT00013_STVA_ID00007_FRT007_CN00013_RETIRADA_EXTERNA_IMEDIATA_PAG_DINHEIRO_PF_LOJA0035() {
		try {
			va.autVAPedidos(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVAPedidos(false).AUT_CLIENT_TYPE = AUT_VA_CADASTROS.FISICA;
	 ...
	 *
	 */
	public void AUT_IT00014_STVA_ID00007_FRT007_CN00014_VA_VALIDA_STATUS_PEDIDO_CRIADO_PF_LOJA0035() {
		try {
	 ...
	 *
	 */
	public void AUT_IT00015_STPDV_ID00007_FRT007_CN00015_PAGAMENTO_PEDIDO_PF_LOJA0035() {
		try {
			pdv.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);	
	 ...
	 *
	 */
	public void AUT_IT00016_STVA_ID00007_FRT007_CN00016_VALIDA_STATUS_PEDIDO_PAGO_PF_LOJA0035() {
		try {
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	...
	@Test
	public void AUT_IT00017_STSAP_ID00007_FRT007_CN00017_FATURA_PEDIDO_PF_LOJA0035() {
		try {
			sap.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 *
	 */
	public void AUT_IT00018_STVA_ID00007_FRT007_CN00018_VALIDA_STATUS_PEDIDO_FATURADO_PF_LOJA0035() {
		try {
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 * 
	 */
	public void AUT_IT00019_STPDV_ID00007_FRT007_CN00019_DEVOLUCAO_PEDIDO_PF_LOJA0035() {
		try {
			pdv.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 *
	 */
	public void AUT_IT00020_STVA_ID00007_FRT007_CN00020_VALIDA_PEDIDO_DEVOLUCAO_PF_LOJA0035() {
		try {
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 *
	 */
	public void AUT_IT00021_STSAFE_ID00007_FRT007_CN00021_VALIDA_VALE_TROCA_PF_LOJA0035() {
		try {
			safe.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 * Executa procedimentos de criação de pedido para pessoa física - Fluxo de saída - Retirada Externa Imediata - Pagamento em Dinheiro
	 */
	public void AUT_IT00022_STVA_ID00007_FRT007_CN00013_RETIRADA_EXTERNA_IMEDIATA_PAG_DINHEIRO_ESTRANGEIRO_LOJA0035() {
		try {
			va.autVAPedidos(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
	 ...
	 *
	 */
	public void AUT_IT00023_STVA_ID00007_FRT007_CN00014_VA_VALIDA_STATUS_PEDIDO_CRIADO_ESTRANGEIRO_LOJA0035() {
		try {
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVAConsultaStatusPedido(va.autVAPedidos(false).AUT_NUMERO_PEDIDO, "Aguardando liberação de pagamento",hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT,hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT);			
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.PASSED);
	 ...
	 *
	 */
	public void AUT_IT00024_STPDV_ID00007_FRT007_CN00015_PAGAMENTO_PEDIDO_ESTRANGEIRO_LOJA0035() {
		try {
			pdv.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);	
			pdv.autStartPagamentoPedido(va.autVAPedidos(false).AUT_NUMERO_PEDIDO,AUT_VA_FLUXO_SAIDA.REITRADA_EXTERNA_IMEDIATA);
			if(pdv.autPDVPagamentos().AUT_STATUS_EXECUTION) {
	 ...
	 * Executa procedimentos de criação de pedido para pessoa física - Fluxo de saída - Retirada Interna Imediata - Pagamento em Dinheiro
	 */
	public void AUT_IT00067_STVA_ID00007_FRT007_CN00013_CAIXA_PAG_DINHEIRO_ESTRANGEIRO_LOJA0035() {
		try {
			va.autVAPedidos(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVAPedidos().AUT_CLIENT_TYPE = AUT_VA_CADASTROS.ESTRANGEIRO;
			va.autVAPedidos().autVAGeracaoPedidosV2(hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT, hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT, AUT_VA_FLUXO_SAIDA.CAIXA.toString(), AUT_VA_MEIOS_PAGAMENTO.DINHEIRO.toString(), AUT_VA_PLANO_PAGAMENTO.A_VISTA.toString(),va.autVACadastros(false).AUT_NUMERO_DOC_PASSAPORTE_OUTPUT);			
	 ...
	 *
	 */
	public void AUT_IT00068_STVA_ID00007_FRT007_CN00014_VA_VALIDA_STATUS_PEDIDO_CRIADO_ESTRANGEIRO_LOJA0035() {
		try {
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVAConsultaStatusPedido(va.autVAPedidos(false).AUT_NUMERO_PEDIDO, "Aguardando liberação de pagamento",hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT,hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT);			
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.PASSED);
	 ...
	 *
	 */
	public void AUT_IT00069_STPDV_ID00007_FRT007_CN00015_PAGAMENTO_PEDIDO_ESTRANGEIRO_LOJA0035() {
		try {
			pdv.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);	
			pdv.autStartPagamentoPedido(va.autVAPedidos(false).AUT_NUMERO_PEDIDO,AUT_VA_FLUXO_SAIDA.CAIXA);
			if(pdv.autPDVPagamentos().AUT_STATUS_EXECUTION) {
	 ...
	 *
	 */
	public void AUT_IT00070_STVA_ID00007_FRT007_CN00016_VALIDA_STATUS_PEDIDO_PAGO_ESTRANGEIRO_LOJA0035() {
		try {
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVAConsultaStatusPedido(va.autVAPedidos(false).AUT_NUMERO_PEDIDO, "Pago",hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT,hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT);			
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.PASSED);
	 ...
	 * 
	 */
	public void AUT_IT00071_STPDV_ID00007_FRT007_CN00019_DEVOLUCAO_PEDIDO_ESTRANGEIRO_LOJA0035() {
		try {
			pdv.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			pdv.autStartDevolucaoItem(va.autVAPedidos(false).AUT_NUMERO_PEDIDO,AUT_VA_FLUXO_SAIDA.CAIXA);
			if(pdv.autPDVDevolucoes().AUT_STATUS_EXECUTION) {
	 ...
	 *
	 */
	public void AUT_IT00072_STVA_ID00007_FRT007_CN00020_VALIDA_PEDIDO_DEVOLUCAO_ESTRANGEIRO_LOJA0035() {
		try {
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVAConsultaStatusPedido(va.autVAPedidos(false).AUT_NUMERO_PEDIDO, "Devolvido",hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT,hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT);			
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.PASSED);
	 ...
	 *
	 */
	public void AUT_IT00073_STSAFE_ID00007_FRT007_CN00021_VALIDA_VALE_TROCA_ESTRANGEIRO_LOJA0035() {
		try {
			safe.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			safe.autCarregarValeTroca(va.autVACadastros(false).AUT_NUMERO_DOC_PASSAPORTE_OUTPUT, AUT_SAFE_TYPE_PERSONS.FISICA);
			safe.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.PASSED);
	 ...
	 * Executa procedimentos de criação de pedido para pessoa física - Fluxo de saída - Retirada Interna Imediata - Pagamento em Dinheiro
	 */
	public void AUT_IT00074_STVA_ID00007_FRT007_CN00013_RETIRADA_INTERNA_IMEDIATA_PAG_DINHEIRO_PJ_LOJA0035() {
		try {
			va.autVAPedidos(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVAPedidos().AUT_CLIENT_TYPE = AUT_VA_CADASTROS.JURIDICA;
			va.autVAPedidos().autVAGeracaoPedidosV2(hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT, hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT, AUT_VA_FLUXO_SAIDA.CAIXA.toString(), AUT_VA_MEIOS_PAGAMENTO.DINHEIRO.toString(), AUT_VA_PLANO_PAGAMENTO.A_VISTA.toString(),va.autVACadastros(false).AUT_NUMERO_DOC_CNPJ_OUTPUT);			
	 ...
	 *
	 */
	public void AUT_IT00075_STVA_ID00007_FRT007_CN00014_VA_VALIDA_STATUS_PEDIDO_CRIADO_PJ_LOJA0035() {
		try {
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVAConsultaStatusPedido(va.autVAPedidos(false).AUT_NUMERO_PEDIDO, "Aguardando liberação de pagamento",hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT,hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT);			
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.PASSED);
	 ...
	 *
	 */
	public void AUT_IT00076_STPDV_ID00007_FRT007_CN00015_PAGAMENTO_PEDIDO_PJ_LOJA0035() {
		try {
			pdv.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);	
			pdv.autStartPagamentoPedido(va.autVAPedidos(false).AUT_NUMERO_PEDIDO,AUT_VA_FLUXO_SAIDA.CAIXA);
			if(pdv.autPDVPagamentos().AUT_STATUS_EXECUTION) {
	 ...
	 *
	 */
	public void AUT_IT00077_STVA_ID00007_FRT007_CN00016_VALIDA_STATUS_PEDIDO_PAGO_PJ_LOJA0035() {
		try {
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVAConsultaStatusPedido(va.autVAPedidos(false).AUT_NUMERO_PEDIDO, "Pago",hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT,hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT);			
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.PASSED);
	 ...
	 * 
	 */
	public void AUT_IT00078_STPDV_ID00007_FRT007_CN00019_DEVOLUCAO_PEDIDO_PJ_LOJA0035() {
		try {
			pdv.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			pdv.autStartDevolucaoItem(va.autVAPedidos(false).AUT_NUMERO_PEDIDO,AUT_VA_FLUXO_SAIDA.CAIXA);
			if(pdv.autPDVDevolucoes().AUT_STATUS_EXECUTION) {
	 ...
	 *
	 */
	public void AUT_IT00079_STVA_ID00007_FRT007_CN00020_VALIDA_PEDIDO_DEVOLUCAO_PJ_LOJA0035() {
		try {
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			va.autVAConsultaStatusPedido(va.autVAPedidos(false).AUT_NUMERO_PEDIDO, "Devolvido",hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_OUTPUT,hmc.autHMCCadastros().AUT_USUARIO_CADASTRO_PWD_OUTPUT);			
			va.autVAConsultas(false).autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.PASSED);
	 ...
	 *
	 */
	public void AUT_IT00080_STSAFE_ID00007_FRT007_CN00021_VALIDA_VALE_TROCA_PJ_LOJA0035() {
		try {
			safe.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
			safe.autCarregarValeTroca(va.autVACadastros(false).AUT_NUMERO_DOC_CNPJ_OUTPUT, AUT_SAFE_TYPE_PERSONS.FISICA);
			safe.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.PASSED);
	 ...
	 * 
	 */
	public void AUT_IT00081_STPDV_ID00007_FRT007_CN00038_LOGOUT_LOJA0035() {				
		try {
			pdv.autSyncStateExecution(AUT_SYNC_EXECUTION_STATE.EXECUTION);
